...
class Index:
    ...
    def __init__(self, *expressions: BaseExpression | Combinable | str, fields: Sequence[str] = ..., name: str | None = ..., db_tablespace: str | None = ..., opclasses: Sequence[str] = ..., condition: Q | None = ..., include: Sequence[str] | None = ...) -> None:
        ...
...
class IndexExpression(Func):
    ...
    def resolve_expression(self, query: Any | None = ..., allow_joins: bool = ..., reuse: set[str] | None = ..., summarize: bool = ..., for_save: bool = ...) -> IndexExpression:
        ...
