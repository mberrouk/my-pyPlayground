...
def get_unique_databases_and_mirrors(aliases: set[str] | None = ...) -> tuple[dict[_Signature, _TestDatabase], dict[str, Any]]:
    ...

def setup_databases(verbosity: int, interactive: bool, *, time_keeper: TimeKeeperProtocol | None = ..., keepdb: bool = ..., debug_sql: bool = ..., parallel: int = ..., aliases: Mapping[str, Any] | None = ..., serialized_aliases: Iterable[str] | None = ..., **kwargs: Any) -> list[tuple[BaseDatabaseWrapper, str, bool]]:
    ...
...
@contextmanager
def register_lookup(field: type[RegisterLookupMixin], *lookups: type[Lookup | Transform], lookup_name: str | None = ...) -> Iterator[None]:
    ...
