...
def CASCADE(collector: Collector, field: Field[Any, Any], sub_objs: QuerySet[Model], using: str) -> None:
    ...

def SET_NULL(collector: Collector, field: Field[Any, Any], sub_objs: QuerySet[Model], using: str) -> None:
    ...

def SET_DEFAULT(collector: Collector, field: Field[Any, Any], sub_objs: QuerySet[Model], using: str) -> None:
    ...

def DO_NOTHING(collector: Collector, field: Field[Any, Any], sub_objs: QuerySet[Model], using: str) -> None:
    ...

def PROTECT(collector: Collector, field: Field[Any, Any], sub_objs: QuerySet[Model], using: str) -> None:
    ...

def RESTRICT(collector: Collector, field: Field[Any, Any], sub_objs: QuerySet[Model], using: str) -> None:
    ...
...
class Collector:
    ...
    def __init__(self, using: str, origin: Model | QuerySet[Model] | None = ...) -> None:
        ...
    
    def add(self, objs: _IndexableCollection[Model], source: type[Model] | None = ..., nullable: bool = ..., reverse_dependency: bool = ...) -> list[Model]:
        ...
    ...
    def collect(self, objs: _IndexableCollection[Model | None], source: type[Model] | None = ..., nullable: bool = ..., collect_related: bool = ..., source_attr: str | None = ..., reverse_dependency: bool = ..., keep_parents: bool = ..., fail_on_restricted: bool = ...) -> None:
        ...
