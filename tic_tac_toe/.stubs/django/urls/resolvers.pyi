...
class ResolverMatch:
    ...
    tried: Any | None
    _func_path: str
    def __init__(self, func: Callable, args: tuple[Any, ...], kwargs: dict[str, Any], url_name: str | None = ..., app_names: list[str | None] | None = ..., namespaces: list[str | None] | None = ..., route: str | None = ..., tried: Any | None = ..., captured_kwargs: dict[str, Any] | None = ..., extra_kwargs: dict[str, Any] | None = ...) -> None:
        ...
...
class URLPattern:
    ...
    name: str | None
    def __init__(self, pattern: _Pattern, callback: Callable, default_args: dict[str, Any] | None = ..., name: str | None = ...) -> None:
        ...
...
class URLResolver:
    ...
    def __init__(self, pattern: _Pattern, urlconf_name: str | Sequence[_AnyURL] | ModuleType, default_kwargs: dict[str, Any] | None = ..., app_name: str | None = ..., namespace: str | None = ...) -> None:
        ...
