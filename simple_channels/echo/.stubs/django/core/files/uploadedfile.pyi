...
class TemporaryUploadedFile(UploadedFile):
    def __init__(self, name: str, content_type: str | None, size: int | None, charset: str | None, content_type_extra: dict[str, str] | None = ...) -> None:
        ...
...
class InMemoryUploadedFile(UploadedFile):
    field_name: str | None
    def __init__(self, file: IO, field_name: str | None, name: str | None, content_type: str | None, size: int | None, charset: str | None, content_type_extra: dict[str, str] | None = ...) -> None:
        ...
