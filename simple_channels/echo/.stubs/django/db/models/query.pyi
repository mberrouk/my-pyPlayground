...
class QuerySet(Generic[_Model, _Row], Iterable[_Row], Sized):
    ...
    def bulk_create(self, objs: Iterable[_Model], batch_size: int | None = ..., ignore_conflicts: bool = ..., update_conflicts: bool = ..., update_fields: Collection[str] | None = ..., unique_fields: Collection[str] | None = ...) -> list[_Model]:
        ...
    
    async def abulk_create(self, objs: Iterable[_Model], batch_size: int | None = ..., ignore_conflicts: bool = ..., update_conflicts: bool = ..., update_fields: Collection[str] | None = ..., unique_fields: Collection[str] | None = ...) -> list[_Model]:
        ...
    
    def bulk_update(self, objs: Iterable[_Model], fields: Iterable[str], batch_size: int | None = ...) -> int:
        ...
    
    async def abulk_update(self, objs: Iterable[_Model], fields: Iterable[str], batch_size: int | None = ...) -> int:
        ...
    ...
    def update_or_create(self, defaults: Mapping[str, Any] | None = ..., create_defaults: Mapping[str, Any] | None = ..., **kwargs: Any) -> tuple[_Model, bool]:
        ...
    
    async def aupdate_or_create(self, defaults: Mapping[str, Any] | None = ..., create_defaults: Mapping[str, Any] | None = ..., **kwargs: Any) -> tuple[_Model, bool]:
        ...
    ...
    def raw(self, raw_query: _ExecuteQuery, params: Any = ..., translations: dict[str, str] | None = ..., using: str | None = ...) -> RawQuerySet:
        ...
    ...
    def datetimes(self, field_name: str, kind: str, order: str = ..., tzinfo: datetime.tzinfo | None = ...) -> QuerySet[_Model, datetime.datetime]:
        ...
    ...
    def extra(self, select: dict[str, Any] | None = ..., where: Sequence[str] | None = ..., params: Sequence[Any] | None = ..., tables: Sequence[str] | None = ..., order_by: Sequence[str] | None = ..., select_params: Sequence[Any] | None = ...) -> QuerySet[Any, Any]:
        ...
...
class RawQuerySet(Iterable[_Model], Sized):
    query: RawQuery
    def __init__(self, raw_query: RawQuery | str, model: type[Model] | None = ..., query: Query | None = ..., params: tuple[Any, ...] = ..., translations: dict[str, str] | None = ..., using: str | None = ..., hints: dict[str, Model] | None = ...) -> None:
        ...
