...
class BaseHandler:
    ...
    def adapt_method_mode(self, is_async: bool, method: Callable[[HttpRequest], HttpResponseBase | Awaitable[HttpResponseBase]], method_is_async: bool | None = ..., debug: bool = ..., name: str | None = ...) -> Callable[[HttpRequest], HttpResponseBase | Awaitable[HttpResponseBase]]:
        ...
