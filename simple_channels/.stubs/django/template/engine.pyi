...
class Engine:
    ...
    def __init__(self, dirs: list[str] | None = ..., app_dirs: bool = ..., context_processors: list[str] | tuple[str, ...] | None = ..., debug: bool = ..., loaders: Sequence[_Loader] | None = ..., string_if_invalid: str = ..., file_charset: str = ..., libraries: dict[str, str] | None = ..., builtins: list[str] | None = ..., autoescape: bool = ...) -> None:
        ...
