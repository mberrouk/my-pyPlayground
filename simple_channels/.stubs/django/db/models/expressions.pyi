...
class BaseExpression:
    ...
    def resolve_expression(self, query: Any | None = ..., allow_joins: bool = ..., reuse: set[str] | None = ..., summarize: bool = ..., for_save: bool = ...) -> Self:
        ...
    ...
    def asc(self, *, descending: bool = ..., nulls_first: bool | None = ..., nulls_last: bool | None = ...) -> OrderBy:
        ...
    
    def desc(self, *, nulls_first: bool | None = ..., nulls_last: bool | None = ...) -> OrderBy:
        ...
...
class F(_Deconstructible, Combinable):
    ...
    def resolve_expression(self, query: Any | None = ..., allow_joins: bool = ..., reuse: set[str] | None = ..., summarize: bool = ..., for_save: bool = ...) -> Expression:
        ...
...
class Sliced(F):
    ...
    def resolve_expression(self, query: Any | None = ..., allow_joins: bool = ..., reuse: set[str] | None = ..., summarize: bool = ..., for_save: bool = ...) -> Func:
        ...
...
class Func(SQLiteNumericMixin, Expression):
    ...
    def as_sql(self, compiler: SQLCompiler, connection: BaseDatabaseWrapper, function: str | None = ..., template: str | None = ..., arg_joiner: str | None = ..., **extra_context: Any) -> _AsSqlType:
        ...
...
class DatabaseDefault(Expression):
    def __init__(self, expression: Expression, output_field: Field | None = ...) -> None:
        ...
...
class ExpressionList(Func):
    def __init__(self, *expressions: BaseExpression | Combinable, output_field: Field | None = ..., **extra: Any) -> None:
        ...
...
class Case(Expression):
    ...
    default: Any
    extra: Any
    def __init__(self, *cases: Any, default: Any | None = ..., output_field: Field | None = ..., **extra: Any) -> None:
        ...
...
class OrderBy(Expression):
    ...
    def __init__(self, expression: Expression | F | Subquery, descending: bool = ..., nulls_first: bool | None = ..., nulls_last: bool | None = ...) -> None:
        ...
...
class Window(SQLiteNumericMixin, Expression):
    ...
    def __init__(self, expression: BaseExpression, partition_by: str | Iterable[BaseExpression | F] | F | BaseExpression | None = ..., order_by: Sequence[BaseExpression | F | str] | BaseExpression | F | str | None = ..., frame: WindowFrame | None = ..., output_field: Field | None = ...) -> None:
        ...
...
class WindowFrame(Expression):
    ...
    def window_frame_start_end(self, connection: BaseDatabaseWrapper, start: int | None, end: int | None) -> tuple[int, int]:
        ...
