...
class BaseModelForm(Generic[_M], BaseForm):
    ...
    def __init__(self, data: _DataT | None = ..., files: _FilesT | None = ..., auto_id: bool | str = ..., prefix: str | None = ..., initial: Mapping[str, Any] | None = ..., error_class: type[ErrorList] = ..., label_suffix: str | None = ..., empty_permitted: bool = ..., instance: _M | None = ..., use_required_attribute: bool | None = ..., renderer: BaseRenderer | None = ...) -> None:
        ...
...
def modelform_factory(model: type[_M], form: type[ModelForm[_M]] = ..., fields: _Fields | None = ..., exclude: _Fields | None = ..., formfield_callback: _FormFieldCallback | None = ..., widgets: _Widgets | None = ..., localized_fields: _Fields | None = ..., labels: _Labels | None = ..., help_texts: _HelpTexts | None = ..., error_messages: _ErrorMessages | None = ..., field_classes: Mapping[str, type[Field]] | None = ...) -> type[ModelForm[_M]]:
    ...
...
class BaseModelFormSet(Generic[_M, _ModelFormT], BaseFormSet[_ModelFormT]):
    ...
    def __init__(self, data: _DataT | None = ..., files: _FilesT | None = ..., auto_id: str = ..., prefix: str | None = ..., queryset: QuerySet[_M] | None = ..., *, initial: Sequence[dict[str, Any]] | None = ..., **kwargs: Any) -> None:
        ...
...
class BaseInlineFormSet(Generic[_M, _ParentM, _ModelFormT], BaseModelFormSet[_M, _ModelFormT]):
    ...
    unique_fields: Collection[str]
    fk: ForeignKey
    def __init__(self, data: _DataT | None = ..., files: _FilesT | None = ..., instance: _ParentM | None = ..., save_as_new: bool = ..., prefix: str | None = ..., queryset: QuerySet[_M] | None = ..., **kwargs: Any) -> None:
        ...
...
class InlineForeignKeyField(Field):
    ...
    pk_field: bool
    to_field: str | None
    def __init__(self, parent_instance: Model, *args: Any, pk_field: bool = ..., to_field: str | None = ..., **kwargs: Any) -> None:
        ...
...
class ModelChoiceField(ChoiceField, Generic[_M]):
    ...
    def __init__(self, queryset: Manager[_M] | QuerySet[_M] | None, *, empty_label: _StrOrPromise | None = ..., required: bool = ..., widget: Widget | type[Widget] | None = ..., label: _StrOrPromise | None = ..., initial: Any | None = ..., help_text: _StrOrPromise = ..., to_field_name: str | None = ..., limit_choices_to: _AllLimitChoicesTo | None = ..., blank: bool = ..., **kwargs: Any) -> None:
        ...
    ...
    choices: _PropertyDescriptor[_Choices | _ChoicesCallable | CallableChoiceIterator, _Choices | CallableChoiceIterator | ModelChoiceIterator,]
...
class ModelMultipleChoiceField(ModelChoiceField[_M]):
    ...
    def to_python(self, value: Any) -> list[_M]:
        ...
