...
class BoundField(RenderableFieldMixin):
    ...
    def as_widget(self, widget: Widget | None = ..., attrs: _AttrsT | None = ..., only_initial: bool = ...) -> SafeString:
        ...
    ...
    def label_tag(self, contents: str | None = ..., attrs: _AttrsT | None = ..., label_suffix: str | None = ..., tag: str | None = ...) -> SafeString:
        ...
    
    def legend_tag(self, contents: str | None = ..., attrs: _AttrsT | None = ..., label_suffix: str | None = ...) -> SafeString:
        ...
