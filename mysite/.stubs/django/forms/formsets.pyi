...
class BaseFormSet(Generic[_F], Sized, RenderableFormMixin):
    ...
    def __init__(self, data: _DataT | None = ..., files: _FilesT | None = ..., auto_id: str = ..., prefix: str | None = ..., initial: Sequence[Mapping[str, Any]] | None = ..., error_class: type[ErrorList] = ..., form_kwargs: dict[str, Any] | None = ..., error_messages: Mapping[str, str] | None = ..., form_renderer: BaseRenderer = ..., renderer: BaseRenderer = ...) -> None:
        ...
...
def formset_factory(form: type[_F], formset: type[BaseFormSet[_F]] = ..., extra: int = ..., can_order: bool = ..., can_delete: bool = ..., max_num: int | None = ..., validate_max: bool = ..., min_num: int | None = ..., validate_min: bool = ..., absolute_max: int | None = ..., can_delete_extra: bool = ...) -> type[BaseFormSet[_F]]:
    ...
