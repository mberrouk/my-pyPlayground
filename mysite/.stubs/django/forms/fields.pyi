...
class Field:
    ...
    def __init__(self, *, required: bool = ..., widget: Widget | type[Widget] | None = ..., label: _StrOrPromise | None = ..., initial: Any | None = ..., help_text: _StrOrPromise = ..., error_messages: _ErrorMessagesMapping | None = ..., show_hidden_initial: bool = ..., validators: Sequence[_ValidatorCallable] = ..., localize: bool = ..., disabled: bool = ..., label_suffix: str | None = ..., template_name: str | None = ...) -> None:
        ...
...
class CharField(Field):
    ...
    def __init__(self, *, max_length: int | None = ..., min_length: int | None = ..., strip: bool = ..., empty_value: str | None = ..., required: bool = ..., widget: Widget | type[Widget] | None = ..., label: _StrOrPromise | None = ..., initial: Any | None = ..., help_text: _StrOrPromise = ..., error_messages: _ErrorMessagesMapping | None = ..., show_hidden_initial: bool = ..., validators: Sequence[_ValidatorCallable] = ..., localize: bool = ..., disabled: bool = ..., label_suffix: str | None = ...) -> None:
        ...
...
class FloatField(IntegerField):
    ...
    def to_python(self, value: Any | None) -> float | None:
        ...
...
class DecimalField(IntegerField):
    ...
    max_digits: int | None
    def __init__(self, *, max_value: Decimal | int | float | None = ..., min_value: Decimal | int | float | None = ..., max_digits: int | None = ..., decimal_places: int | None = ..., step_size: Decimal | int | float | None = ..., required: bool = ..., widget: Widget | type[Widget] | None = ..., label: _StrOrPromise | None = ..., initial: Any | None = ..., help_text: _StrOrPromise = ..., error_messages: _ErrorMessagesMapping | None = ..., show_hidden_initial: bool = ..., validators: Sequence[_ValidatorCallable] = ..., localize: bool = ..., disabled: bool = ..., label_suffix: str | None = ...) -> None:
        ...
    
    def to_python(self, value: Any | None) -> Decimal | None:
        ...
...
class BaseTemporalField(Field):
    input_formats: Any
    def __init__(self, *, input_formats: Any | None = ..., required: bool = ..., widget: Widget | type[Widget] | None = ..., label: _StrOrPromise | None = ..., initial: Any | None = ..., help_text: _StrOrPromise = ..., error_messages: _ErrorMessagesMapping | None = ..., show_hidden_initial: bool = ..., validators: Sequence[_ValidatorCallable] = ..., localize: bool = ..., disabled: bool = ..., label_suffix: str | None = ...) -> None:
        ...
...
class FileField(Field):
    ...
    max_length: int | None
    def __init__(self, *, max_length: int | None = ..., allow_empty_file: bool = ..., required: bool = ..., widget: Widget | type[Widget] | None = ..., label: _StrOrPromise | None = ..., initial: Any | None = ..., help_text: _StrOrPromise = ..., error_messages: _ErrorMessagesMapping | None = ..., show_hidden_initial: bool = ..., validators: Sequence[_ValidatorCallable] = ..., localize: bool = ..., disabled: bool = ..., label_suffix: str | None = ...) -> None:
        ...
...
class URLField(CharField):
    def __init__(self, *, max_length: int | None = ..., min_length: int | None = ..., strip: bool = ..., empty_value: str | None = ..., required: bool = ..., widget: Widget | type[Widget] | None = ..., label: _StrOrPromise | None = ..., initial: Any | None = ..., help_text: _StrOrPromise = ..., error_messages: _ErrorMessagesMapping | None = ..., show_hidden_initial: bool = ..., validators: Sequence[_ValidatorCallable] = ..., localize: bool = ..., disabled: bool = ..., label_suffix: str | None = ..., assume_scheme: str | None = ...) -> None:
        ...
...
class NullBooleanField(BooleanField):
    def to_python(self, value: Any | None) -> bool | None:
        ...
...
class ChoiceField(Field):
    choices: _PropertyDescriptor[_Choices | _ChoicesCallable | CallableChoiceIterator, _Choices | CallableChoiceIterator,]
    widget: _ClassLevelWidgetT
    def __init__(self, *, choices: _Choices | _ChoicesCallable = ..., required: bool = ..., widget: Widget | type[Widget] | None = ..., label: _StrOrPromise | None = ..., initial: Any | None = ..., help_text: _StrOrPromise = ..., error_messages: _ErrorMessagesMapping | None = ..., show_hidden_initial: bool = ..., validators: Sequence[_ValidatorCallable] = ..., localize: bool = ..., disabled: bool = ..., label_suffix: str | None = ...) -> None:
        ...
...
class ComboField(Field):
    ...
    def __init__(self, fields: Sequence[Field], *, required: bool = ..., widget: Widget | type[Widget] | None = ..., label: _StrOrPromise | None = ..., initial: Any | None = ..., help_text: _StrOrPromise = ..., error_messages: _ErrorMessagesMapping | None = ..., show_hidden_initial: bool = ..., validators: Sequence[_ValidatorCallable] = ..., localize: bool = ..., disabled: bool = ..., label_suffix: str | None = ...) -> None:
        ...
...
class MultiValueField(Field):
    ...
    fields: Sequence[Field]
    def __init__(self, fields: Sequence[Field], *, require_all_fields: bool = ..., required: bool = ..., widget: Widget | type[Widget] | None = ..., label: _StrOrPromise | None = ..., initial: Any | None = ..., help_text: _StrOrPromise = ..., error_messages: _ErrorMessagesMapping | None = ..., show_hidden_initial: bool = ..., validators: Sequence[_ValidatorCallable] = ..., localize: bool = ..., disabled: bool = ..., label_suffix: str | None = ...) -> None:
        ...
...
class FilePathField(ChoiceField):
    ...
    def __init__(self, path: str, *, match: str | None = ..., recursive: bool = ..., allow_files: bool = ..., allow_folders: bool = ..., choices: _Choices | _ChoicesCallable = ..., required: bool = ..., widget: Widget | type[Widget] | None = ..., label: _StrOrPromise | None = ..., initial: Any | None = ..., help_text: _StrOrPromise = ..., error_messages: _ErrorMessagesMapping | None = ..., show_hidden_initial: bool = ..., validators: Sequence[_ValidatorCallable] = ..., localize: bool = ..., disabled: bool = ..., label_suffix: str | None = ...) -> None:
        ...
...
class GenericIPAddressField(CharField):
    unpack_ipv4: bool
    def __init__(self, *, protocol: str = ..., unpack_ipv4: bool = ..., required: bool = ..., widget: Widget | type[Widget] | None = ..., label: _StrOrPromise | None = ..., initial: Any | None = ..., help_text: _StrOrPromise = ..., error_messages: _ErrorMessagesMapping | None = ..., show_hidden_initial: bool = ..., validators: Sequence[_ValidatorCallable] = ..., localize: bool = ..., disabled: bool = ..., label_suffix: str | None = ...) -> None:
        ...
...
class SlugField(CharField):
    allow_unicode: bool
    def __init__(self, *, allow_unicode: bool = ..., max_length: Any | None = ..., min_length: Any | None = ..., strip: bool = ..., empty_value: str | None = ..., required: bool = ..., widget: Widget | type[Widget] | None = ..., label: _StrOrPromise | None = ..., initial: Any | None = ..., help_text: _StrOrPromise = ..., error_messages: _ErrorMessagesMapping | None = ..., show_hidden_initial: bool = ..., validators: Sequence[_ValidatorCallable] = ..., localize: bool = ..., disabled: bool = ..., label_suffix: str | None = ...) -> None:
        ...
