...
class BaseDatabaseSchemaEditor(AbstractContextManager[Any]):
    ...
    def column_sql(self, model: type[Model], field: Field, include_default: bool = ...) -> tuple[None, None] | tuple[str, list[Any]]:
        ...
    ...
    def alter_db_table_comment(self, model: type[Model], old_db_table_comment: str, new_db_table_comment: str) -> None:
        ...
