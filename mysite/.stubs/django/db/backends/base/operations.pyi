...
class BaseDatabaseOperations:
    ...
    def adapt_decimalfield_value(self, value: Decimal | None, max_digits: int | None = ..., decimal_places: int | None = ...) -> str | None:
        ...
    ...
    def convert_durationfield_value(self, value: float | None, expression: Expression, connection: BaseDatabaseWrapper) -> timedelta | None:
        ...
    ...
    def on_conflict_suffix_sql(self, fields: Any, on_conflict: Any, update_fields: Any, unique_fields: Any) -> str | Any:
        ...
    
    def format_for_duration_arithmetic(self, sql: str) -> str:
        ...
    
    def prepare_join_on_clause(self, lhs_table: str, lhs_field: Field, rhs_table: str, rhs_field: Field) -> tuple[Col, Col]:
        ...
