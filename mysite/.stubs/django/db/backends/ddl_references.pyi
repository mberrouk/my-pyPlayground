...
class Columns(TableColumns):
    ...
    def __init__(self, table: str, columns: list[str], quote_name: _QuoteCallable, col_suffixes: Sequence[str] = ...) -> None:
        ...
...
class ForeignKeyName(TableColumns):
    ...
    def __init__(self, from_table: str, from_columns: list[str], to_table: str, to_columns: list[str], suffix_template: str, create_fk_name: _NameCallable) -> None:
        ...
