...
_SQLType: TypeAlias = (None | bool | int | float | Decimal | str | bytes | datetime.date | datetime.datetime | UUID | tuple[Any, ...] | list[Any])
...
class CursorWrapper:
    ...
    def callproc(self, procname: str, params: Sequence[Any] | None = ..., kparams: dict[str, int] | None = ...) -> Any:
        ...
...
class CursorDebugWrapper(CursorWrapper):
    ...
    db: Any
    @contextmanager
    def debug_sql(self, sql: str | None = ..., params: _ExecuteParameters | Sequence[_ExecuteParameters] | None = ..., use_last_executed_query: bool = ..., many: bool = ...) -> Generator[None, None, None]:
        ...
    


@overload
def typecast_date(s: None | Literal[""]) -> None:
    ...
...
@overload
def typecast_time(s: None | Literal[""]) -> None:
    ...
