...
class Query(BaseExpression):
    ...
    def __init__(self, model: type[Model] | None, alias_cols: bool = ...) -> None:
        ...
    ...
    def add_annotation(self, annotation: Any, alias: str, select: bool = ...) -> None:
        ...
    ...
    def get_compiler(self, using: str | None = ..., connection: Any | None = ..., elide_empty: bool = ...) -> Any:
        ...
    
    def join_parent_model(self, opts: Any, model: Any | None, alias: str, seen: dict[Any, str]) -> str:
        ...
    
    def names_to_path(self, names: list[str], opts: Any, allow_many: bool = ..., fail_on_missing: bool = ...) -> tuple[list[Any], Any, tuple[Any, ...], list[str]]:
        ...
    ...
    def get_group_by_cols(self, wrapper: Any | None = ...) -> list[Any]:
        ...
    ...
    def exists(self, limit: bool = ...) -> Any:
        ...
    ...
    def bump_prefix(self, other_query: Query, exclude: Any | None = ...) -> None:
        ...
    ...
    def resolve_lookup_value(self, value: Any, can_reuse: set[str] | None, allow_joins: bool, summarize: bool = ...) -> Any:
        ...
    
    def solve_lookup_type(self, lookup: str, summarize: bool = ...) -> tuple[Sequence[str], Sequence[str], Expression | Literal[False]]:
        ...
    
    def table_alias(self, table_name: str, create: bool = ..., filtered_relation: Any | None = ...) -> tuple[str, bool]:
        ...
    
    def get_aggregation(self, using: Any, aggregate_exprs: dict[str, Any]) -> dict[str, Any]:
        ...
    
    def build_filter(self, filter_expr: Q | Expression | dict[str, str] | tuple[str, Any], branch_negated: bool = ..., current_negated: bool = ..., can_reuse: set[str] | None = ..., allow_joins: bool = ..., split_subq: bool = ..., check_filterable: bool = ..., summarize: bool = ..., update_join_types: bool = ...) -> tuple[WhereNode, Iterable[str]]:
        ...
    ...
    def setup_joins(self, names: Sequence[str], opts: Any, alias: str, can_reuse: set[str] | None = ..., allow_many: bool = ...) -> JoinInfo:
        ...
    ...
    def split_exclude(self, filter_expr: tuple[str, Any], can_reuse: set[str], names_with_path: list[tuple[str, list[PathInfo]]]) -> tuple[WhereNode, Iterable[str]]:
        ...
    ...
    def clear_ordering(self, force: bool = ..., clear_default: bool = ...) -> None:
        ...
    ...
    def add_extra(self, select: dict[str, Any] | None, select_params: Iterable[Any] | None, where: Sequence[str] | None, params: Sequence[str] | None, tables: Sequence[str] | None, order_by: Sequence[str] | None) -> None:
        ...
    ...
    def join(self, join: BaseTable | Join, reuse: str | None = ...) -> str:
        ...
