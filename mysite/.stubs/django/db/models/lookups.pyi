...
class Lookup(Expression, Generic[_T]):
    ...
    def batch_process_rhs(self, compiler: SQLCompiler, connection: BaseDatabaseWrapper, rhs: OrderedSet | None = ...) -> tuple[list[str], list[str]]:
        ...
    ...
    def process_lhs(self, compiler: SQLCompiler, connection: BaseDatabaseWrapper, lhs: Expression | None = ...) -> _AsSqlType:
        ...
...
class FieldGetDbPrepValueIterableMixin(FieldGetDbPrepValueMixin):
    ...
    def resolve_expression_parameter(self, compiler: SQLCompiler, connection: BaseDatabaseWrapper, sql: str, param: Any) -> _AsSqlType:
        ...
