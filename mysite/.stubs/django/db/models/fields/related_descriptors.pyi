...
class ForwardManyToOneDescriptor(Generic[_F]):
    ...
    def get_prefetch_queryset(self, instances: list[Model], queryset: QuerySet[Any] | None = ...) -> tuple[QuerySet[Any], Callable[..., Any], Callable[..., Any], bool, str, bool]:
        ...
    
    def get_prefetch_querysets(self, instances: list[Model], querysets: list[QuerySet[Any]] | None = ...) -> tuple[QuerySet[Any], Callable[..., Any], Callable[..., Any], bool, str, bool]:
        ...
    
    def get_object(self, instance: Model) -> Model:
        ...
    
    def __get__(self, instance: Model | None, cls: type[Model] | None = ...) -> Model | ForwardManyToOneDescriptor | None:
        ...
...
class ReverseOneToOneDescriptor(Generic[_From, _To]):
    ...
    def get_prefetch_queryset(self, instances: list[_From], queryset: QuerySet[_To] | None = ...) -> tuple[QuerySet[_To], Callable[..., Any], Callable[..., Any], bool, str, bool]:
        ...
    
    def get_prefetch_querysets(self, instances: list[_From], querysets: list[QuerySet[_To]] | None = ...) -> tuple[QuerySet[_To], Callable[..., Any], Callable[..., Any], bool, str, bool]:
        ...
...
def create_reverse_many_to_one_manager(superclass: type[BaseManager[_M]], rel: ManyToOneRel) -> type[RelatedManager[_M]]:
    ...
...
class ManyToManyDescriptor(ReverseManyToOneDescriptor, Generic[_To, _Through]):
    ...
    @cached_property
    def related_manager_cls(self) -> type[ManyRelatedManager[_To, _Through]]:
        ...
...
class ManyRelatedManager(Manager[_To], Generic[_To, _Through]):
    ...
    def set(self, objs: QuerySet[_To] | Iterable[_To | int], *, bulk: bool = ..., clear: bool = ..., through_defaults: dict[str, Any] | None = ...) -> None:
        ...
    
    async def aset(self, objs: QuerySet[_To] | Iterable[_To | int], *, bulk: bool = ..., clear: bool = ..., through_defaults: dict[str, Any] | None = ...) -> None:
        ...
...
def create_forward_many_to_many_manager(superclass: type[BaseManager[_To]], rel: ManyToManyRel, reverse: bool) -> type[ManyRelatedManager[_To, _Through]]:
    ...
