...
class Field(RegisterLookupMixin, Generic[_ST, _GT]):
    ...
    def formfield(self, form_class: type[forms.Field] | None = ..., choices_form_class: type[forms.ChoiceField] | None = ..., **kwargs: Any) -> forms.Field | None:
        ...
    ...
    def get_choices(self, include_blank: bool = ..., blank_choice: _ChoicesList = ..., limit_choices_to: _LimitChoicesTo | None = ..., ordering: Sequence[str] = ...) -> BlankChoiceIterator | _ChoicesList:
        ...
...
class NullBooleanField(BooleanField[_ST, _GT]):
    _pyi_private_set_type: bool | Combinable | None
    _pyi_private_get_type: bool | None
    _pyi_lookup_exact_type: bool | None
    ...
