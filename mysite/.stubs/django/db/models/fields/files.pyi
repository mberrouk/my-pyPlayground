...
from django.db.models.fields import Field, NOT_PROVIDED, _ErrorMessagesMapping
...
class ImageField(FileField):
    def __init__(self, verbose_name: _StrOrPromise | None = ..., name: str | None = ..., width_field: str | None = ..., height_field: str | None = ..., **kwargs: Any) -> None:
        ...
