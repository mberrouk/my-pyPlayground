...
class Q(tree.Node):
    ...
    def resolve_expression(self, query: Query | None = ..., allow_joins: bool = ..., reuse: set[str] | None = ..., summarize: bool = ..., for_save: bool = ...) -> WhereNode:
        ...
...
class DeferredAttribute:
    ...
    def __get__(self, instance: Model | None, cls: type[Model] | None = ...) -> Any:
        ...
...
def select_related_descend(field: Field, restricted: bool, requested: Mapping[str, Any] | None, load_fields: Collection[str] | None, reverse: bool = ...) -> bool:
    ...

_E = TypeVar("_E", bound=BaseExpression)
def refs_expression(lookup_parts: Sequence[str], annotations: Mapping[str, _E]) -> tuple[Literal[False] | _E, Sequence[str]]:
    ...
