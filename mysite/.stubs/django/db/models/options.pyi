...
_OptionTogetherT: TypeAlias = _ListOrTuple[_ListOrTuple[str] | str] | set[tuple[str, ...]]
@overload
...
class Options(Generic[_M]):
    ...
    indexes: list[Any]
    unique_together: Sequence[tuple[str, ...]]
    index_together: Sequence[tuple[str, ...]]
    select_on_save: bool
    ...
    def get_fields(self, include_parents: bool = ..., include_hidden: bool = ...) -> list[Field[Any, Any] | ForeignObjectRel | GenericForeignKey]:
        ...
