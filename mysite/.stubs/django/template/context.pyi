...
class Context(BaseContext):
    ...
    def __init__(self, dict_: Any | None = ..., autoescape: bool = ..., use_l10n: bool | None = ..., use_tz: bool | None = ...) -> None:
        ...
...
class RequestContext(Context):
    ...
    use_tz: bool | None
    request: HttpRequest
    def __init__(self, request: HttpRequest, dict_: dict[str, Any] | None = ..., processors: list[Callable] | None = ..., use_l10n: bool | None = ..., use_tz: bool | None = ..., autoescape: bool = ...) -> None:
        ...
...
def make_context(context: dict[str, Any] | None, request: HttpRequest | None = ..., **kwargs: Any) -> Context:
    ...
