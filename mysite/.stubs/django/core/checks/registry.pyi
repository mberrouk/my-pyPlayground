...
class _CheckCallable(Protocol):
    def __call__(self, *, app_configs: Sequence[AppConfig] | None, databases: Sequence[str] | None, **kwargs: Any) -> Iterable[CheckMessage]:
        ...
...
class CheckRegistry:
    ...
    @overload
    def register(self, check: str | None = ..., *tags: str, **kwargs: Any) -> Callable[[_C], _ProcessedCheckCallable[_C]]:
        ...
    
    def run_checks(self, app_configs: Sequence[AppConfig] | None = ..., tags: Sequence[str] | None = ..., include_deployment_checks: bool = ..., databases: Sequence[str] | None = ...) -> list[CheckMessage]:
        ...
