...
class ASGIRequest(HttpRequest):
    ...
    @cached_property
    def GET(self) -> _ImmutableQueryDict:
        ...
...
class ASGIHandler(base.BaseHandler):
    ...
    async def __call__(self, scope: dict[str, Any], receive: _ReceiveCallback, send: _SendCallback) -> None:
        ...
    
    async def handle(self, scope: dict[str, Any], receive: _ReceiveCallback, send: _SendCallback) -> HttpResponseBase | None:
        ...
    ...
    def create_request(self, scope: Mapping[str, Any], body_file: IO[bytes]) -> tuple[ASGIRequest, None] | tuple[None, HttpResponseBase]:
        ...
