...
class RegexValidator(_Deconstructible):
    ...
    inverse_match: bool
    flags: int
    def __init__(self, regex: _Regex | None = ..., message: _StrOrPromise | None = ..., code: str | None = ..., inverse_match: bool | None = ..., flags: RegexFlag | None = ...) -> None:
        ...
...
class EmailValidator(_Deconstructible):
    ...
    def __init__(self, message: _StrOrPromise | None = ..., code: str | None = ..., allowlist: Sequence[str] | None = ...) -> None:
        ...
...
def int_list_validator(sep: str = ..., message: _StrOrPromise | None = ..., code: str = ..., allow_negative: bool = ...) -> RegexValidator:
    ...
...
class StepValueValidator(BaseValidator):
    offset: int | None
    def __init__(self, limit_value: Any | Callable[[], Any], message: _StrOrPromise | None = ..., offset: int | None = ...) -> None:
        ...
...
class FileExtensionValidator(_Deconstructible):
    ...
    def __init__(self, allowed_extensions: Collection[str] | None = ..., message: _StrOrPromise | None = ..., code: str | None = ...) -> None:
        ...
