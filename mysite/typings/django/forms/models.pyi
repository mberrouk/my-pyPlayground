...
def modelformset_factory(model, form=..., formfield_callback=..., formset=..., extra=..., can_delete=..., can_order=..., max_num=..., fields=..., exclude=..., widgets=..., validate_max=..., localized_fields=..., labels=..., help_texts=..., error_messages=..., min_num=..., validate_min=..., field_classes=..., absolute_max=..., can_delete_extra=..., renderer=..., edit_only=...):
...
def inlineformset_factory(parent_model, model, form=..., formset=..., fk_name=..., fields=..., exclude=..., extra=..., can_order=..., can_delete=..., max_num=..., formfield_callback=..., widgets=..., validate_max=..., localized_fields=..., labels=..., help_texts=..., error_messages=..., min_num=..., validate_min=..., field_classes=..., absolute_max=..., can_delete_extra=..., renderer=..., edit_only=...):
    """
