...
from django.db import ProgrammingError as ProgrammingError
...
class BaseDatabaseFeatures:
    ...
    introspected_field_types: Incomplete
    ...
    create_test_procedure_without_params_sql: Incomplete
    create_test_procedure_with_int_param_sql: Incomplete
    create_test_table_with_composite_primary_key: Incomplete
    ...
    prohibits_null_characters_in_text_exception: Incomplete
    supports_unlimited_charfield: bool
    test_collations: Incomplete
    test_now_utc_template: Incomplete
    insert_test_table_with_defaults: Incomplete
    django_test_expected_failures: Incomplete
    django_test_skips: Incomplete
